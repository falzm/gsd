...
func TestPlan_Execute_NoError(t *testing.T) {
	...
	err = plan.
		AddStep(&GenericStep{
			PreExec:  func(ctx context.Context, state *State) error { return testStepFunc(state, "b") },
			Exec:     func(ctx context.Context, state *State) error { return testStepFunc(state, "o") },
			PostExec: func(ctx context.Context, state *State) error { return testStepFunc(state, "b") },
			Cleanup:  func(ctx context.Context, state *State) { _ = testStepFunc(state, "o") },
		}).
		AddStep(&GenericStep{
			PreExec:  func(ctx context.Context, state *State) error { return testStepFunc(state, "k") },
			Exec:     func(ctx context.Context, state *State) error { return testStepFunc(state, "e") },
			PostExec: func(ctx context.Context, state *State) error { return testStepFunc(state, "l") },
			Cleanup:  func(ctx context.Context, state *State) { _ = testStepFunc(state, "s") },
		}).
...
func TestPlan_Execute_IntermediateFail(t *testing.T) {
	...
	err = plan.
		...
		AddStep(&GenericStep{
			PreExec: func(ctx context.Context, state *State) error { return errors.New("blah") },
		}).
		Execute(context.Background())
...
func TestPlan_Execute_FailFirst(t *testing.T) {
	...
	require.Error(t, plan.
		AddStep(&GenericStep{
			PreExec:  func(ctx context.Context, state *State) error { return errors.New("blah") },
			Exec:     func(ctx context.Context, state *State) error { return testStepFunc(state, "b") },
			PostExec: func(ctx context.Context, state *State) error { return testStepFunc(state, "o") },
			Cleanup:  func(ctx context.Context, state *State) { _ = testStepFunc(state, "b") },
		}).
		Execute(context.Background()))
...
func TestPlan_Execute_WithTimeout(t *testing.T) {
	...
	err = plan.
		AddStep(&GenericStep{
			Exec: func(ctx context.Context, state *State) error {
				select {
